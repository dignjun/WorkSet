...
public class SimpleWrapper implements Wrapper, Pipeline, Lifecycle {
	...
	public Servlet allocate() throws ServletException {
		if (instance == null) {
			try {
				...
				throw new ServletException("Cannot allocate a servlet instace",
						e);
			}
		}
		return instance;
	...
	public Servlet loadServlet() throws ServletException {
		...
		if (actualClass == null)
			throw new ServletException("servlet class has not bee specified");
		...
		try {
			...
			throw new ServletException("Failed initalize servlet.");
		}
		return servlet;
	}
